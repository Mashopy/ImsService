...
.method private parseKeepAliveConfig([Ljava/lang/String;)Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveConfig;
    ...
    .line 296
    const-string v0, "parseKeepAliveConfig() result is null"
    ...
    .line 302
    .local v2, "config":Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveConfig;
    const/4 v0, 0x0
    ...
    .line 308
    .local v12, "dstPort":I
    new-instance v5, Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveConfig;
...
.method startPacketKeepAlive(Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveConfig;)V
    ...
    .line 318
    const-string v1, "startPacketKeepAlive: finally close socket"

    const-string v2, "startPacketKeepAlive finally exception: "
    ...
    .line 330
    .local v10, "callback":Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$WfcKeepAliveCallback;
    iget-object v0, p0, Lcom/mediatek/wfo/util/PacketKeepAliveProcessor;->mConnectivityManager:Landroid/net/ConnectivityManager;
    ...
    invoke-direct {p0, v5}, Lcom/mediatek/wfo/util/PacketKeepAliveProcessor;->isActiveWifiNetwork(Landroid/net/Network;)Z
    ...
    :try_start_0
    invoke-virtual {v11, v0}, Ljava/net/Socket;->setReuseAddress(Z)V
    ...
    invoke-virtual {v11, v0}, Ljava/net/Socket;->bind(Ljava/net/SocketAddress;)V
    ...
    .line 345
    .local v0, "ka":Landroid/net/SocketKeepalive;
    iget v4, p1, Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveConfig;->interval:I

    invoke-virtual {v0, v4}, Landroid/net/SocketKeepalive;->start(I)V

    .line 346
    new-instance v4, Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveInfo;

    invoke-direct {v4, p0, v0, p1, v10}, Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveInfo;-><init>(Lcom/mediatek/wfo/util/PacketKeepAliveProcessor;Landroid/net/SocketKeepalive;Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveConfig;Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$WfcKeepAliveCallback;)V

    .line 347
    .local v4, "kai":Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveInfo;
    ...
    .line 352
    .end local v0    # "ka":Landroid/net/SocketKeepalive;
    .end local v4    # "kai":Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveInfo;
    ...
    .line 351
    .end local v12    # "isSocketClosed":Z
    .local v4, "isSocketClosed":Z
    :catchall_1
    move-exception v0
    ...
    const-string v7, "startPacketKeepAlive exception: "
    ...
    .line 360
    .end local v4    # "isSocketClosed":Z
    .end local v11    # "socket":Ljava/net/Socket;
    :goto_3
    nop
    ...
    .line 352
    .restart local v11    # "socket":Ljava/net/Socket;
    .restart local v12    # "isSocketClosed":Z
    :goto_4
    if-nez v12, :cond_4
...
.method stopPacketKeepAlive(Lcom/mediatek/wfo/util/PacketKeepAliveProcessor$KeepAliveConfig;)V
    ...
    iget-object v3, p0, Lcom/mediatek/wfo/util/PacketKeepAliveProcessor;->mWifiPdnHandler:Landroid/os/Handler;

    const/16 v4, 0x3ef

    invoke-virtual {v3, v4, v1, v1, p1}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
