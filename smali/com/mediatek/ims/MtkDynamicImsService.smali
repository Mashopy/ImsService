...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/mediatek/ims/MtkDynamicImsService$CallComposerEventCallback;
    }
.end annotation
...
# direct methods
.method static bridge synthetic -$$Nest$mupdateRcsFeatureTag(Lcom/mediatek/ims/MtkDynamicImsService;I)V
    .locals 0
...
.method private updateRcsFeatureTag(I)V
    ...
    .line 471
    :try_start_0
    invoke-virtual {v1, p1}, Lcom/mediatek/ims/ImsService;->getImsRegistrationTech(I)I
...
.method public getConfig(I)Landroid/telephony/ims/stub/ImsConfigImplBase;
    ...
    .end local v0    # "config":Landroid/telephony/ims/stub/ImsConfigImplBase;
    .local v4, "config":Landroid/telephony/ims/stub/ImsConfigImplBase;
    goto :goto_0

    .line 326
    .end local v4    # "config":Landroid/telephony/ims/stub/ImsConfigImplBase;
    .restart local v0    # "config":Landroid/telephony/ims/stub/ImsConfigImplBase;
    :cond_0
    if-eqz v3, :cond_2
    ...
    .line 328
    .end local v0    # "config":Landroid/telephony/ims/stub/ImsConfigImplBase;
    .restart local v4    # "config":Landroid/telephony/ims/stub/ImsConfigImplBase;
    sget-boolean v0, Lcom/mediatek/ims/MtkDynamicImsService;->DEBUG:Z

    if-eqz v0, :cond_1

    .line 329
    const-string v0, "RCSFEATURE >> getConfig"
...
.method public getImsServiceCapabilities()J
    ...
    .line 385
    :cond_0
    const-string v2, "ro.vendor.mtk_mipc_support"
...
.method public readyForFeatureCreation()V
    ...
    .line 234
    invoke-virtual {v2, v4}, Lcom/mediatek/ims/rcs/UaServiceManager;->stopService(I)V
    ...
    .line 220
    .local v4, "phoneId":I
    invoke-virtual {v2, v4}, Lcom/mediatek/ims/rcs/UaServiceManager;->startService(I)V
    ...
    .line 222
    .local v5, "mainHdlr":Landroid/os/Handler;
    if-eqz v0, :cond_3

    .line 223
    new-instance v6, Lcom/mediatek/ims/MtkDynamicImsService$ImsEventCallbackExt;

    invoke-direct {v6, p0, v5}, Lcom/mediatek/ims/MtkDynamicImsService$ImsEventCallbackExt;-><init>(Lcom/mediatek/ims/MtkDynamicImsService;Landroid/os/Handler;)V

    invoke-virtual {v2, v4, v6}, Lcom/mediatek/ims/rcs/UaServiceManager;->registerStateCallback(ILcom/mediatek/ims/rcs/UaServiceManager$StateCallback;)V
    ...
    .line 226
    new-instance v6, Lcom/mediatek/ims/MtkDynamicImsService$CallComposerEventCallback;

    invoke-direct {v6, p0, v5}, Lcom/mediatek/ims/MtkDynamicImsService$CallComposerEventCallback;-><init>(Lcom/mediatek/ims/MtkDynamicImsService;Landroid/os/Handler;)V

    invoke-virtual {v2, v4, v6}, Lcom/mediatek/ims/rcs/UaServiceManager;->registerCallComposerCallback(ILcom/mediatek/ims/rcs/UaServiceManager$CallComposerCallback;)V

    .line 218
    .end local v4    # "phoneId":I
    .end local v5    # "mainHdlr":Landroid/os/Handler;
    :cond_4
