...
.method private checkUtCapability(ILandroid/telephony/ims/feature/MmTelFeature$MmTelCapabilities;)Landroid/telephony/ims/feature/MmTelFeature$MmTelCapabilities;
    .locals 2
    .param p1, "phoneId"    # I
    .param p2, "cap"    # Landroid/telephony/ims/feature/MmTelFeature$MmTelCapabilities;
    ...
    invoke-direct {p0, p1, v1}, Lcom/mediatek/ims/ImsService;->getBooleanFromCarrierConfig(ILjava/lang/String;)Z
    ...
    .line 4065
    invoke-virtual {p2, v0}, Landroid/telephony/ims/feature/MmTelFeature$MmTelCapabilities;->removeCapabilities(I)V
...
.method private notifyRegistrationCapabilityChange(IIZ)V
    ...
    invoke-direct {p0, p1, v2}, Lcom/mediatek/ims/ImsService;->checkUtCapability(ILandroid/telephony/ims/feature/MmTelFeature$MmTelCapabilities;)Landroid/telephony/ims/feature/MmTelFeature$MmTelCapabilities;
...
.method private sendIncomingCallIndication(ILandroid/os/AsyncResult;)V
    ...
    iget-object v2, v0, Lcom/mediatek/ims/ImsService;->mIsPendingMTTerminated:[Z
    ...
    iget-object v4, v0, Lcom/mediatek/ims/ImsService;->mHandler:[Landroid/os/Handler;
    ...
    invoke-interface {v2, v4, v5, v6}, Lcom/mediatek/ims/ril/ImsCommandsInterface;->registerForCallInfo(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    iget-object v3, v0, Lcom/mediatek/ims/ImsService;->mPendingMTCallId:[Ljava/lang/String;
    ...
    const-string v7, "sendIncomingCallIndication() : call_id = "
    ...
    .line 3656
    invoke-direct {v0, v3}, Lcom/mediatek/ims/ImsService;->sensitiveEncode(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 3655
    invoke-direct {v0, v6}, Lcom/mediatek/ims/ImsService;->log(Ljava/lang/String;)V
    ...
    .line 3664
    .local v6, "isAllow":Z
    sget-object v7, Lcom/mediatek/ims/ImsConstants;->PROPERTY_TBCW_MODE:Ljava/lang/String;

    sget-object v12, Lcom/mediatek/ims/ImsConstants;->TBCW_DISABLED:Ljava/lang/String;

    invoke-static {v1, v7, v12}, Landroid/telephony/TelephonyManager;->getTelephonyProperty(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    .line 3668
    .local v12, "callWaitingSetting":Ljava/lang/String;
    sget-object v7, Lcom/mediatek/ims/ImsConstants;->TBCW_OFF:Ljava/lang/String;
    ...
    .line 3670
    const-string v4, "sendIncomingCallIndication() : PROPERTY_TBCW_MODE = TBCW_OFF. Reject the call as UDUB "
    ...
    .line 3677
    const-string v4, "sendIncomingCallIndication() : there is an ECC call, dis-allow this incoming call!"
    ...
    .line 3682
    :cond_1
    const-string v4, "allow_hold_video_call_bool"

    invoke-direct {v0, v1, v4}, Lcom/mediatek/ims/ImsService;->getBooleanFromCarrierConfig(ILjava/lang/String;)Z
    ...
    .line 3686
    const-string v4, "sendIncomingCallIndication() : OP01 or OP09 case"
    ...
    .line 3690
    const-string v4, "sendIncomingCallIndication() : there is video calls, dis-allow this incoming call!"
    ...
    invoke-virtual {v11, v4}, Lcom/mediatek/ims/ImsServiceCallTracker;->isVideoCall(I)Z
    ...
    .line 3695
    const-string v4, "sendIncomingCallIndication() : MT is video calls during call, dis-allow this incoming call!"
    ...
    invoke-static {v4, v1}, Lcom/mediatek/ims/OperatorUtils;->isMatched(Lcom/mediatek/ims/OperatorUtils$OPID;I)Z
    ...
    .line 3703
    const-string v4, "sendIncomingCallIndication() : OP129 case"
    ...
    .line 3707
    const-string v4, "sendIncomingCallIndication() : there is conference call, dis-allow this incoming call!"
    ...
    .line 3717
    :cond_4
    iget-object v4, v0, Lcom/mediatek/ims/ImsService;->mContext:Landroid/content/Context;

    invoke-static {v4, v1}, Lcom/android/ims/ImsManager;->getInstance(Landroid/content/Context;I)Lcom/android/ims/ImsManager;
    ...
    .line 3719
    :cond_5
    const-string v4, "sendIncomingCallIndication() : ImsService is not ready"
    ...
    const-string v7, "sendIncomingCallIndication() : isAllow = "
    ...
    .line 3732
    :cond_7
    const-string v4, "mtk_support_enhanced_call_blocking_bool"
    ...
    .line 3735
    .local v15, "needCheckEnhanceCallBlacking":Z
    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "sendIncomingCallIndication() : needCheckEnhanceCallBlacking = "
    ...
    const-string v7, "com.android.ims.IMS_INCOMING_CALL_INDICATION"
    ...
    .line 3743
    const-string v7, "android:imsCallMode"
    ...
    .line 3746
    const-string v2, "mediatek:mtToNumber"

    invoke-virtual {v4, v2, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    .line 3747
    iget-object v2, v0, Lcom/mediatek/ims/ImsService;->mPendingMTSeqNum:[Ljava/lang/String;

    aput-object v10, v2, v1

    .line 3748
    iget-object v2, v0, Lcom/mediatek/ims/ImsService;->mContext:Landroid/content/Context;
    ...
    .line 3750
    .end local v16    # "callId":Ljava/lang/String;
    ...
    .line 3751
    .end local v2    # "callId":Ljava/lang/String;
    .restart local v16    # "callId":Ljava/lang/String;
    invoke-static {v10}, Ljava/lang/Integer;->parseInt(Ljava/lang/String;)I
    ...
    .line 3754
    .end local v15    # "needCheckEnhanceCallBlacking":Z
    :goto_1
    return-void
.end method
