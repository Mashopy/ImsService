...
.method constructor <init>(Landroid/content/Context;Landroid/telephony/ims/ImsCallProfile;Landroid/telephony/ims/ImsCallSessionListener;Lcom/mediatek/ims/ImsService;Landroid/os/Handler;Lcom/mediatek/ims/ril/ImsCommandsInterface;I)V
    ...
    const-string v2, "MtkImsCallSessionProxy() : RILAdapter = "
...
.method public notifyTextCapabilityChanged(IIII)V
    ...
    :cond_0
    :try_start_0
    iget-object v2, p0, Lcom/mediatek/ims/MtkImsCallSessionProxy;->mMtkListener:Lcom/mediatek/ims/internal/IMtkImsCallSessionListener;

    iget-object v3, p0, Lcom/mediatek/ims/MtkImsCallSessionProxy;->mServiceImpl:Lcom/mediatek/ims/internal/IMtkImsCallSession;
    :try_end_0
    ...
    .end local p1    # "localCapability":I
    .end local p2    # "remoteCapability":I
    .end local p3    # "localTextStatus":I
    .end local p4    # "realRemoteCapability":I
    .local v4, "localCapability":I
    .local v5, "remoteCapability":I
    .local v6, "localTextStatus":I
    .local v7, "realRemoteCapability":I
    :try_start_1
    invoke-interface/range {v2 .. v7}, Lcom/mediatek/ims/internal/IMtkImsCallSessionListener;->callSessionTextCapabilityChanged(Lcom/mediatek/ims/internal/IMtkImsCallSession;IIII)V
    :try_end_1
    ...
    .end local v5    # "remoteCapability":I
    .end local v6    # "localTextStatus":I
    .end local v7    # "realRemoteCapability":I
    .restart local p1    # "localCapability":I
    .restart local p2    # "remoteCapability":I
    .restart local p3    # "localTextStatus":I
    .restart local p4    # "realRemoteCapability":I
    :catch_1
    move-exception v0
    ...
    .end local p3    # "localTextStatus":I
    .end local p4    # "realRemoteCapability":I
    .restart local v4    # "localCapability":I
    .restart local v5    # "remoteCapability":I
    .restart local v6    # "localTextStatus":I
    .restart local v7    # "realRemoteCapability":I
    .local p1, "e":Landroid/os/RemoteException;
    :goto_0
    const-string p2, "RemoteException callSessionTextCapabilityChanged()"
