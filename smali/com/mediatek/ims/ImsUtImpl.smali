...
.method public static encryptString(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1209
    .end local v1    # "textByte":[B
    .local v2, "textByte":[B
    goto :goto_0

    .line 1206
    .end local v2    # "textByte":[B
    .restart local v1    # "textByte":[B
    :catch_0
    move-exception v2
...
.method public updateCallBarring(II[Ljava/lang/String;)I
    ...
    invoke-virtual {v2, v3, v0, v1, v4}, Lcom/mediatek/ims/ImsUtImpl$ResultHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public updateCallBarringWithPassword(II[Ljava/lang/String;ILjava/lang/String;)I
    ...
    new-array v2, v2, [Lcom/mediatek/ims/MtkImsBarringCall;

    .local v2, "barCalls":[Lcom/mediatek/ims/MtkImsBarringCall;
    goto :goto_1

    .line 914
    .end local v2    # "barCalls":[Lcom/mediatek/ims/MtkImsBarringCall;
    :cond_1
    new-array v2, v3, [Lcom/mediatek/ims/MtkImsBarringCall;

    .line 915
    .restart local v2    # "barCalls":[Lcom/mediatek/ims/MtkImsBarringCall;
    ...
    iput p2, v3, Lcom/mediatek/ims/MtkImsBarringCall;->status:I
    ...
    invoke-virtual {v3, v7, v0, v1, v4}, Lcom/mediatek/ims/ImsUtImpl$ResultHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-interface {v3, v2, v1}, Lcom/mediatek/ims/ril/ImsCommandsInterface;->setBarringCalls([Lcom/mediatek/ims/MtkImsBarringCall;Landroid/os/Message;)V
...
.method public updateCallForward(IILjava/lang/String;II)I
    ...
    invoke-virtual {v1, v4, v0, v2, v3}, Lcom/mediatek/ims/ImsUtImpl$ResultHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v11

    .line 959
    .local v11, "msg":Landroid/os/Message;
    iget-object v5, p0, Lcom/mediatek/ims/ImsUtImpl;->mImsRILAdapter:Lcom/mediatek/ims/ril/ImsCommandsInterface;

    invoke-virtual/range {p0 .. p1}, Lcom/mediatek/ims/ImsUtImpl;->getCFActionFromAction(I)I
    ...
    invoke-interface/range {v5 .. v11}, Lcom/mediatek/ims/ril/ImsCommandsInterface;->setCallForward(IIILjava/lang/String;ILandroid/os/Message;)V
...
.method public updateCallForwardUncondTimer(IIIIIILjava/lang/String;)I
    ...
    const-string v3, "updateCallForwardUncondTimer(): Time is wrong! "
    ...
    iget-object v3, v1, Lcom/mediatek/ims/ImsUtImpl;->mHandler:Lcom/mediatek/ims/ImsUtImpl$ResultHandler;
    ...
    invoke-virtual {v3, v6, v0, v4, v5}, Lcom/mediatek/ims/ImsUtImpl$ResultHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v18

    .line 1190
    .local v18, "msg":Landroid/os/Message;
    iget-object v11, v1, Lcom/mediatek/ims/ImsUtImpl;->mImsRILAdapter:Lcom/mediatek/ims/ril/ImsCommandsInterface;

    move/from16 v3, p5

    invoke-virtual {v1, v3}, Lcom/mediatek/ims/ImsUtImpl;->getCFActionFromAction(I)I
    ...
    invoke-virtual {v1, v4}, Lcom/mediatek/ims/ImsUtImpl;->getCFReasonFromCondition(I)I

    move-result v13

    .line 1193
    invoke-direct {v1, v2}, Lcom/mediatek/ims/ImsUtImpl;->convertToTimeSlotArray(Ljava/lang/String;)[J
    ...
    invoke-interface/range {v11 .. v18}, Lcom/mediatek/ims/ril/ImsCommandsInterface;->setCallForwardInTimeSlot(IIILjava/lang/String;I[JLandroid/os/Message;)V
