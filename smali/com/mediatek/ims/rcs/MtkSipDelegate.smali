...
.method private encodeSipMessage([B)Landroid/telephony/ims/SipMessage;
    ...
    .line 468
    .end local v1    # "startLine":Ljava/lang/String;
    .local v7, "startLine":Ljava/lang/String;
    ...
    .line 469
    .end local v7    # "startLine":Ljava/lang/String;
    .restart local v1    # "startLine":Ljava/lang/String;
    :cond_0
    invoke-virtual {v5}, Lcom/mediatek/ims/rcs/MtkSipDelegate$LineReader;->read()[C
...
.method private notifyConfigurationChanged(Lcom/mediatek/ims/rcsua/Configuration;)V
    ...
    invoke-virtual {v2}, Lcom/mediatek/ims/rcsua/Configuration;->getPublicGruu()Ljava/lang/String;
    ...
    .line 150
    .local v6, "localTxPort":I
    invoke-virtual {v2}, Lcom/mediatek/ims/rcsua/Configuration;->getViaPort()I

    move-result v7

    .line 151
    .local v7, "localRxPort":I
    const/4 v9, 0x0

    .line 152
    .local v9, "remoteTxPort":I
    invoke-virtual {v2}, Lcom/mediatek/ims/rcsua/Configuration;->getPortS()I

    move-result v10

    .line 153
    .local v10, "remoteRxPort":I
    invoke-virtual {v2}, Lcom/mediatek/ims/rcsua/Configuration;->getSecurityVerify()Ljava/lang/String;
    ...
    .local v16, "version":J
    :goto_0
    invoke-virtual {v2}, Lcom/mediatek/ims/rcsua/Configuration;->getLocalAddress()Ljava/lang/String;
    ...
    .line 163
    .local v13, "localAddr":Ljava/lang/String;
    invoke-virtual {v2}, Lcom/mediatek/ims/rcsua/Configuration;->getProxyAddress()Ljava/lang/String;
    ...
    .line 165
    .local v14, "serverAddr":Ljava/lang/String;
    ...
    .line 168
    invoke-virtual {v2}, Lcom/mediatek/ims/rcsua/Configuration;->getLocalPort()I

    move-result v11

    invoke-direct {v5, v8, v11}, Ljava/net/InetSocketAddress;-><init>(Ljava/net/InetAddress;I)V
    ...
    invoke-direct {v8, v11, v2}, Ljava/net/InetSocketAddress;-><init>(Ljava/net/InetAddress;I)V
    ...
    invoke-direct/range {v15 .. v20}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;-><init>(JILjava/net/InetSocketAddress;Ljava/net/InetSocketAddress;)V

    .line 172
    .local v15, "builder":Landroid/telephony/ims/SipDelegateConfiguration$Builder;
    ...
    invoke-virtual {v15, v2}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setPublicUserIdentifier(Ljava/lang/String;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;
    ...
    invoke-virtual {v5, v8}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setPrivateUserIdentifier(Ljava/lang/String;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;

    move-result-object v5

    .line 175
    invoke-direct {v0, v2}, Lcom/mediatek/ims/rcs/MtkSipDelegate;->extractUserParameter(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v5, v8}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setSipContactUserParameter(Ljava/lang/String;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;
    ...
    invoke-virtual {v5, v8}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setHomeDomain(Ljava/lang/String;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;
    ...
    invoke-virtual {v5, v8}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setSipAssociatedUriHeader(Ljava/lang/String;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;
    ...
    invoke-virtual {v5, v8}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setSipPaniHeader(Ljava/lang/String;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;
    ...
    invoke-virtual {v5, v8}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setSipServiceRouteHeader(Ljava/lang/String;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;

    move-result-object v5

    move-object v8, v5

    new-instance v5, Landroid/telephony/ims/SipDelegateConfiguration$IpSecConfiguration;
    ...
    .local v19, "impu":Ljava/lang/String;
    ...
    .line 180
    invoke-virtual {v2, v5}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setIpSecConfiguration(Landroid/telephony/ims/SipDelegateConfiguration$IpSecConfiguration;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;
    ...
    invoke-virtual {v2, v5}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setSipUserAgentHeader(Ljava/lang/String;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;
    ...
    invoke-virtual {v2, v5}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setMaxUdpPayloadSizeBytes(I)Landroid/telephony/ims/SipDelegateConfiguration$Builder;

    move-result-object v2

    iget v5, v0, Lcom/mediatek/ims/rcs/MtkSipDelegate;->phoneId:I
    ...
    invoke-virtual {v2, v5}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setImei(Ljava/lang/String;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;
    ...
    invoke-virtual {v2, v5}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setSipCompactFormEnabled(Z)Landroid/telephony/ims/SipDelegateConfiguration$Builder;
    ...
    .line 190
    invoke-virtual {v15, v2}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->setSipPlaniHeader(Ljava/lang/String;)Landroid/telephony/ims/SipDelegateConfiguration$Builder;

    .line 193
    :cond_3
    invoke-virtual {v15}, Landroid/telephony/ims/SipDelegateConfiguration$Builder;->build()Landroid/telephony/ims/SipDelegateConfiguration;

    move-result-object v5

    iput-object v5, v0, Lcom/mediatek/ims/rcs/MtkSipDelegate;->delegateConfig:Landroid/telephony/ims/SipDelegateConfiguration;
    ...
    const-string v8, "notifyConfigurationChanged >> report configuraiton{version["

    invoke-virtual {v5, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v8, v0, Lcom/mediatek/ims/rcs/MtkSipDelegate;->delegateConfig:Landroid/telephony/ims/SipDelegateConfiguration;
    ...
    .end local v2    # "plani":Ljava/lang/String;
    .local v11, "tm":Landroid/telephony/TelephonyManager;
    .local v18, "plani":Ljava/lang/String;
    invoke-virtual {v8}, Landroid/telephony/ims/SipDelegateConfiguration;->getVersion()J
    ...
    iget-object v2, v0, Lcom/mediatek/ims/rcs/MtkSipDelegate;->delegateConfig:Landroid/telephony/ims/SipDelegateConfiguration;

    .line 197
    invoke-virtual {v2}, Landroid/telephony/ims/SipDelegateConfiguration;->getTransportType()I
    ...
    .line 198
    invoke-virtual {v2}, Landroid/telephony/ims/SipDelegateConfiguration;->getSipServerAddress()Ljava/net/InetSocketAddress;
    ...
    .line 200
    iget-object v1, v0, Lcom/mediatek/ims/rcs/MtkSipDelegate;->stateCallback:Landroid/telephony/ims/DelegateStateCallback;

    iget-object v2, v0, Lcom/mediatek/ims/rcs/MtkSipDelegate;->delegateConfig:Landroid/telephony/ims/SipDelegateConfiguration;

    invoke-interface {v1, v2}, Landroid/telephony/ims/DelegateStateCallback;->onConfigurationChanged(Landroid/telephony/ims/SipDelegateConfiguration;)V
