...
.method public isInMergeProgress(Ljava/lang/String;)Z
    ...
    const-string v3, "isInMergeProgress : Id :"
...
.method public processCallInfoIndication([Ljava/lang/String;Lcom/mediatek/ims/ImsCallSessionProxy;Landroid/telephony/ims/ImsCallProfile;)V
    ...
    .line 424
    .local v4, "callNum":Ljava/lang/String;
    const/4 v5, 0x0
    ...
    .line 446
    .local v11, "isRemoteHold":Z
    const/4 v15, 0x0

    .line 447
    .local v15, "imsCallInfo":Lcom/mediatek/ims/ImsCallInfo;
    const-string v9, ", isEcc = "

    const-string v10, ", isVideo = "

    const-string v12, ", isConferenceHost = "
    ...
    .end local v4    # "callNum":Ljava/lang/String;
    ...
    .end local v11    # "isRemoteHold":Z
    .local v17, "isRemoteHold":Z
    const-string v11, "processCallInfoIndication() : CALL_MSG_TYPE_ACTIVE_BY_REMOTE => callId = "
    ...
    check-cast v15, Lcom/mediatek/ims/ImsCallInfo;
    ...
    iput-boolean v1, v15, Lcom/mediatek/ims/ImsCallInfo;->mIsRemoteHold:Z

    .line 608
    iget-object v1, v0, Lcom/mediatek/ims/ImsServiceCallTracker;->mCallConnections:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, v3, v15}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v17    # "isRemoteHold":Z
    .restart local v4    # "callNum":Ljava/lang/String;
    .restart local v11    # "isRemoteHold":Z
    :sswitch_1
    move-object/from16 v16, v4
    ...
    .end local v4    # "callNum":Ljava/lang/String;
    .end local v11    # "isRemoteHold":Z
    .restart local v16    # "callNum":Ljava/lang/String;
    .restart local v17    # "isRemoteHold":Z
    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "processCallInfoIndication() : CALL_MSG_TYPE_HELD_BY_REMOTE => callId = "
    ...
    const-string v11, "processCallInfoIndication() : CALL_MSG_TYPE_DISCONNECTED => callId = "
    ...
    .line 570
    :cond_7
    sget-object v1, Lcom/mediatek/ims/ImsCallInfo$State;->DISCONNECTED:Lcom/mediatek/ims/ImsCallInfo$State;

    iput-object v1, v15, Lcom/mediatek/ims/ImsCallInfo;->mState:Lcom/mediatek/ims/ImsCallInfo$State;

    .line 571
    iput-boolean v5, v15, Lcom/mediatek/ims/ImsCallInfo;->mIsConference:Z

    .line 572
    iput-boolean v6, v15, Lcom/mediatek/ims/ImsCallInfo;->mIsConferenceHost:Z

    .line 573
    iput-boolean v7, v15, Lcom/mediatek/ims/ImsCallInfo;->mIsVideo:Z
    ...
    const-string v11, "processCallInfoIndication() : CALL_MSG_TYPE_ACTIVE => callId = "
    ...
    const-string v11, "processCallInfoIndication() : CALL_MSG_TYPE_HELD => callId = "
    ...
    const-string v11, "processCallInfoIndication() : CALL_MSG_TYPE_ID_ASSIGN => callId = "
    ...
    .line 483
    sget-object v10, Lcom/mediatek/ims/ImsCallInfo$State;->ALERTING:Lcom/mediatek/ims/ImsCallInfo$State;

    .line 484
    .local v10, "state":Lcom/mediatek/ims/ImsCallInfo$State;
    const/4 v1, 0x0

    .line 485
    .local v1, "isStkCall":Z
    const/16 v2, 0x14
    ...
    .line 489
    .end local v1    # "isStkCall":Z
    .local v9, "isStkCall":Z
    :goto_1
    iget-object v1, v0, Lcom/mediatek/ims/ImsServiceCallTracker;->mCallConnections:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v2, Lcom/mediatek/ims/ImsCallInfo;
    ...
    .line 505
    .end local v9    # "isStkCall":Z
    .end local v10    # "state":Lcom/mediatek/ims/ImsCallInfo$State;
    :sswitch_6
    move-object/from16 v16, v4
    ...
    .end local v11    # "isRemoteHold":Z
    .restart local v17    # "isRemoteHold":Z
    const-string v11, "processCallInfoIndication() : CALL_MSG_TYPE_ALERT => callId = "
    ...
    const-string v11, "processCallInfoIndication() : CALL_MSG_TYPE_MT => callId = "
    ...
    .line 458
    sget-object v10, Lcom/mediatek/ims/ImsCallInfo$State;->INCOMING:Lcom/mediatek/ims/ImsCallInfo$State;

    .line 459
    .restart local v10    # "state":Lcom/mediatek/ims/ImsCallInfo$State;
    iget-object v1, v0, Lcom/mediatek/ims/ImsServiceCallTracker;->mCallConnections:Ljava/util/concurrent/ConcurrentHashMap;
