...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/mediatek/ims/ril/ImsCommandsInterface;I)V
    ...
    invoke-interface {v0, v1, v2, v3}, Lcom/mediatek/ims/ril/ImsCommandsInterface;->registerForLteMsgWaiting(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v0, v1, v2, v3}, Lcom/mediatek/ims/ril/ImsCommandsInterface;->registerForImsDialog(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private handleDialogEventPackage(Ljava/util/ArrayList;)V
    ...
    .line 170
    .local v9, "localAddr":Landroid/net/Uri;
    iget-object v5, v4, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->remoteAddress:Ljava/lang/String;
    ...
    .line 171
    .local v8, "addr":Landroid/net/Uri;
    new-instance v6, Landroid/telephony/ims/ImsExternalCallState;
    ...
    iget-object v7, v4, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->remoteAddress:Ljava/lang/String;
    ...
    iget-object v7, v4, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->address:Ljava/lang/String;
    ...
    iget-boolean v7, v4, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->isPullable:Z

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v7, v4, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->callState:I

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v7, v4, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->callType:I

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v7, v4, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->isCallHeld:Z
    ...
    .end local v8    # "addr":Landroid/net/Uri;
    .end local v9    # "localAddr":Landroid/net/Uri;
    goto :goto_0
    ...
    .line 183
    .local v8, "localAddr":Landroid/net/Uri;
    ...
    .line 184
    .local v7, "addr":Landroid/net/Uri;
    const/4 v14, 0x0

    .line 186
    .local v14, "exCallState":Landroid/telephony/ims/ImsExternalCallState;
    :try_start_0
    sget-object v0, Lcom/mediatek/ims/ImsEventPackageAdapter;->sImsExternalCallStateConstructfunc:Ljava/lang/reflect/Constructor;

    iget v6, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->dialogId:I
    ...
    iget-boolean v9, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->isPullable:Z

    invoke-static {v9}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v9

    iget v10, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->callState:I

    invoke-static {v10}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v10

    iget v11, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->callType:I
    ...
    iget-boolean v12, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->isCallHeld:Z

    invoke-static {v12}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v12

    iget-boolean v13, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->isMt:Z
    ...
    .line 195
    .end local v14    # "exCallState":Landroid/telephony/ims/ImsExternalCallState;
    ...
    .restart local v14    # "exCallState":Landroid/telephony/ims/ImsExternalCallState;
    :catch_0
    move-exception v0
    ...
    .end local v7    # "addr":Landroid/net/Uri;
    .local v8, "addr":Landroid/net/Uri;
    .restart local v9    # "localAddr":Landroid/net/Uri;
    ...
    .end local v9    # "localAddr":Landroid/net/Uri;
    .restart local v7    # "addr":Landroid/net/Uri;
    .local v8, "localAddr":Landroid/net/Uri;
    move-object v0, v6
    ...
    iget v9, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->dialogId:I

    invoke-virtual {v6, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v9, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->remoteAddress:Ljava/lang/String;

    .line 198
    invoke-static {v9}, Lcom/mediatek/ims/ImsServiceCallTracker;->sensitiveEncode(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->address:Ljava/lang/String;
    ...
    iget v9, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->callState:I

    invoke-virtual {v6, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v9, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->callType:I

    invoke-virtual {v6, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v9, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->isCallHeld:Z

    invoke-virtual {v6, v9}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v9, v5, Lvendor/mediatek/hardware/mtkradioex/V3_0/Dialog;->isMt:Z
    ...
    .end local v7    # "addr":Landroid/net/Uri;
    .end local v8    # "localAddr":Landroid/net/Uri;
    goto/16 :goto_1
    ...
    .line 206
    iget-object v1, p0, Lcom/mediatek/ims/ImsEventPackageAdapter;->mContext:Landroid/content/Context;
...
.method private handleLetMessageWaiting([Ljava/lang/String;)V
    ...
    .line 133
    .local v3, "isFirstPkt":Z
    :cond_2
    iget-object v1, p0, Lcom/mediatek/ims/ImsEventPackageAdapter;->mMWIData:Ljava/lang/String;

    invoke-direct {p0, v3, v1, v7}, Lcom/mediatek/ims/ImsEventPackageAdapter;->concatData(ZLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lcom/mediatek/ims/ImsEventPackageAdapter;->mMWIData:Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Lcom/mediatek/ims/ImsEventPackageAdapter;->recoverDataFromAsciiTag(Ljava/lang/String;)Ljava/lang/String;
